...
void loop() {
  ...
  if(Serial1.available()) {
    float xVel = 0;
    float yVel = 0;
    float dummy1 = 0; // Data for Robot 2, not used but has to be parsed
    float dummy2 = 0;
    float dummy3 = 0; // Data for Robot 3, not used but has to be parsed
    float dummy4 = 0;
    xVel = Serial1.parseFloat(); //computer input
